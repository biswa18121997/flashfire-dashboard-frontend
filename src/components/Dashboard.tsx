  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {userDetails.planType == 'Free Trial' && <div className="rounded-2xl p-2 m-4 border-4 absolute w-1/4 top-[10%] left-[70%] border-yellow-400 border-dashed bg-yellow-50 shadow-md">
...
//           const parsedAuth = JSON.parse(storedAuth);
//           if (!parsedAuth?.userDetails?.planType) {
//             console.log('Dashboard: Setting newUserModal to true (FetchAllJobs)');
//             setNewUserModal(true);
//           }
//         }
//       } else if (data.message === 'invalid token please login again') {
...
//       }
//     } catch (err) {
//       console.error('FetchAllJobs error:', err);
//     } finally {
//       setLoadingDetails(false);
//     }
//   }
...
//   useEffect(() => {
//     console.log('Dashboard: newUserModal state:', newUserModal);
//     FetchAllJobs(token, userDetails);
//     const storedAuth = localStorage.getItem('userAuth');
//     if (userDetails?.planType == null || (storedAuth && !JSON.parse(storedAuth)?.userDetails?.planType)) {
//       console.log('Dashboard: Setting newUserModal to true (useEffect)');
//       setNewUserModal(true);
//     }
//   }, [token, userDetails]);
...
//     <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
//         {/* Update NewUserModal to include isOpen prop */}
//         <NewUserModal isOpen={newUserModal} setNewUserModal={setNewUserModal} />
//         {/* Header */}
//         <div className="text-center mb-12">
//           <h1 className="text-4xl font-bold text-gray-900 mb-4">
//             Welcome to Your Career Dashboard
...
//                   {jobs.length > 0
//                     ? Math.round(
//                         ((jobs.filter(item => item.currentStatus === 'interviewing').length +
//                           jobs.filter(item => item.currentStatus === 'offer').length +
//                           jobs.filter(item => item.currentStatus === 'rejected').length) /
//                           jobs.length) * 100
//                       )
//                     : 0}%
//                 </p>
