            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <div className="flex items-start justify-between">
                        <div className="flex-1 border-l-4 border-orange-600 pl-6 py-2">
                            <h1 className="mt-2 text-balance text-4xl md:text-4xl font-extrabold tracking-tight leading-[1.1]">
                ...
                {uniqueJobs.length === 0 && (
                    <div className="mb-8 rounded-xl border border-dashed border-gray-300 bg-white p-6">
                        ...
                        <button
                            ...
                            className="bg-gradient-to-r from-orange-300 to-red-300 hover:from-orange-600 hover:to-red-700 text-gray hover:text-white px-5 py-2 rounded-lg font-medium transition-all duration-200"
                        >
                            Add Your First Job
                        </button>
                    </div>
