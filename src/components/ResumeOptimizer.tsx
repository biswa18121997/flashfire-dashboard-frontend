        ...
        <aside className="col-span-12 md:col-span-3 fixed top-25 ml-4 w-1/5 left-0 ">
          <div className="bg-white rounded-lg shadow border">
            ...
            <nav className="flex md:flex-col">
              <button
                className={`px-4 py-3 text-left w-full hover:bg-gray-50 ${activeTab === "base"
              ...
              <button
                className={`px-4 py-3 text-left w-full hover:bg-gray-50 ${activeTab === "optimized"
                  ? "bg-blue-50 text-blue-700 font-medium"
                  : ""
                  }`}
                onClick={() => {
              ...
              <button
                className={`px-4 py-3 text-left w-full hover:bg-gray-50 ${activeTab === "cover"
                  ? "bg-blue-50 text-blue-700 font-medium"
                  : ""
                  }`}
                onClick={() => {
