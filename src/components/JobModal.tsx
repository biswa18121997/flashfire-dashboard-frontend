...
import { X, Building, Briefcase, Calendar, User, FileText, ArrowRight, Link, Copy, ExternalLink } from "lucide-react"; import { useState, Suspense, lazy } from "react"; import LoadingScreen from "./LoadingScreen"; const AttachmentsModal = lazy(() => import("./AttachmentsModal"));
export default function JobModal({ setShowJobModal, jobDetails }) {
const [attachmentsModalActiveStatus, setAttachmentsModalActiveStatus] = useState(false);
const [selectedImage, setSelectedImage] = useState(null);
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-orange-100 text-sm">{jobDetails.jobTitle} at {jobDetails.companyName}</p>
          </div>
        </div>
        <button
          onClick={() => setShowJobModal(false)}
