...
const [activeSection, setActiveSection] = useState<Sections>(initialSection ?? "details");
...
useEffect(() => {
  ...
  const exists = hasOptimizedResumeLocal(jobDetails?.jobID, jobDetails?.companyName);
